...
def generate_full_name (first_name, last_name):
    space = ' '
      full_name = first_name + space + last_name
      return full_name
print('Full Name: ', generate_full_name('Shree','Yetayeh'))
...
def print_fullname(firstname, lastname):
    ...
    print(full_name)
print_fullname(firstname = 'Shree', lastname = 'Yetayeh')
...
def print_name(firstname):
    return firstname
print_name('Shree') # Shree

def print_full_name(firstname, lastname):
    space = ' '
    full_name = firstname  + space + lastname
    return full_name
print_full_name(firstname='Shree', lastname='Yetayeh')
```
...
def generate_full_name (first_name = 'Shree', last_name = 'Yetayeh'):
    space = ' '
    full_name = first_name + space + last_name
    return full_name
...
def generate_groups (team,*args):
    ...
    for i in args:
        print(i) 
generate_groups('Team-1','Shree','Brook','David','Eyob')
```
