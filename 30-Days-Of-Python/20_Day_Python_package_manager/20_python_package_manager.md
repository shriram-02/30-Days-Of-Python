...
```sh
shree@Shree:~$ pip install pandas
```
...
url_lists = [
    'http://www.python.org',
    'https://www.linkedin.com/in/shree/',
    'https://github.com/Shree',
    'https://twitter.com/Shree',
]
...
```sh
shree@Shree:~$ pip show --verbose pandas
Name: pandas
Version: 1.2.3
Summary: Powerful data structures for data analysis, time series, and statistics
Home-page: http://pandas.pydata.org
...
```py
shree@Shree:~$ pip install requests
```
...
```sh
shree@Shree:~/Desktop/30DaysOfPython$ python
Python 3.9.6 (default, Jun 28 2021, 15:26:21)
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
...
>>> greet.greet_person('Shree', 'Yetayeh')
'Shree Yetayeh, welcome to 30DaysOfPython Challenge!'
>>>
```
