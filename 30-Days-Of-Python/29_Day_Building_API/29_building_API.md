...
#
MONGODB_URI='mongodb+srv://shree:your_password@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority'
...
We can access single document using an id, let's access Shree using his id.
