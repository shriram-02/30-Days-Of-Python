...
```python
dct = {'name':'Shree','country':'Finland','city':'Helsinki'}
```
...
```python
data = {'Name': ['Shree', 'David', 'John'], 'Country':[
...
```python
data = [
    {'Name': 'Shree', 'Country': 'Finland', 'City': 'Helsinki'},
...
```sh
curl -O https://raw.githubusercontent.com/Shree/30-Days-Of-Python/master/data/weight-height.csv
```
