...
```sh
shree@Shree:~/Desktop$ mkdir python_for_web
shree@Shree:~/Desktop$ cd python_for_web/
shree@Shree:~/Desktop/python_for_web$ virtualenv venv
shree@Shree:~/Desktop/python_for_web$ source venv/bin/activate
(env) shree@Shree:~/Desktop/python_for_web$ pip freeze
(env) shree@Shree:~/Desktop/python_for_web$ pip install Flask
(env) shree@Shree:~/Desktop/python_for_web$ pip freeze
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) shree@Shree:~/Desktop/python_for_web$
```
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) shree@Shree:~/Desktop/python_for_web$ touch requirements.txt
(env) shree@Shree:~/Desktop/python_for_web$ pip freeze > requirements.txt
(env) shree@Shree:~/Desktop/python_for_web$ cat requirements.txt
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
Jinja2==2.10.3
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) shree@Shree:~/Desktop/python_for_web$ touch Procfile
(env) shree@Shree:~/Desktop/python_for_web$ ls
Procfile          env/              static/
